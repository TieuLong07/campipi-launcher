/** Lucide-style inline SVG, 1.75px stroke, no emoji, currentColor. */
...
export const IconLog = ({ size = 16, className }: IconProps) => (
...
export const IconInfo = ({ size = 14, className }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10" />
...
export const IconLogout = ({ size = 13, className }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
