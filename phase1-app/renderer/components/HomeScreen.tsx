  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      for (const p of particles) {
        ...
        ctx.fillStyle = `rgba(245, 200, 100, ${p.life * 0.7})`;
        ctx.fill();
      }
      ...
      <div className="hero" data-testid="hero">
        ...
        <div className="hero-top">
          <div className="hero-top-row">
            ...
            <div className="hero-stats" data-testid="hero-stats">
              ...
              <div className="stat">
                <div className="stat-value">1.20.1</div>
                <div className="stat-label">MC</div>
              </div>
              <div className="stat">
                <div className="stat-value">47.4.10</div>
                <div className="stat-label">Forge</div>
              </div>
            </div>
          </div>
        </div>
        <div className="hero-bottom">
          <div className="hero-headline">
            ...
            <div className="hero-pills" data-testid="hero-pills">
              <span className="pill">Combat 1.20.1</span>
              <span className="pill pill-amber">TACZ Firearms</span>
              <span className="pill">GeckoLib Anim</span>
              <span className="pill pill-amber">Citadel</span>
              <span className="pill">49 Mods</span>
            </div>
          </div>
